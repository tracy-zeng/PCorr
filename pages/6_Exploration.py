...
def load_relation_data():
    df_ppi_all = pickle.load(open(os.path.join(script_dir, "data/de_novo_PPIs_08.pkl"), 'rb'))
    df_tpi_all = pickle.load(open(os.path.join(script_dir, "data/de_novo_TPIs_08.pkl"), 'rb'))
    df_trinet_all = pickle.load(open(os.path.join(script_dir, "data/de_novo_TriNET_08.pkl"), 'rb'))
    return df_ppi_all, df_tpi_all, df_trinet_all

@st.cache_data
def load_DGI_data():
    df_dgi_all = pickle.load(open(os.path.join(script_dir, "data/de_novo_DGIs_08.pkl"), 'rb'))
    return df_dgi_all
